...
@section('content')
    <form class="bounceIn" id="dist_regForm" method="POST" action="{{ route('addDist_select') }}">
        @csrf

        <h1>Please Select District Location :</h1>
        ...
        <div class="tab">City:
            <select class="form form-select mt-2 p-2" name="city" onchange="cityName()" oninput="this.className = ''" id="city">
    ...
    <script>
        ...
        function nextPrev(n) {
            ...
            if (currentTab >= x.length) {
                ...
                document.getElementById("dist_regForm").submit();
                return true;
            }
